...
window.onload = function () {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        data.forEach(function (elem) {
          ...
          var editBook = document.createElement('a');
          var deleteBook = document.createElement('a');
          var book_edit_delete = document.createElement('td');
          ...
          $(deleteBook).addClass('delete-book'); // автор

          var author_edit_delete = document.createElement('td');

          for (var j = 0; j < elem.at_name.length; j++) {
            if (elem.author_id[j] !== null) {
              var author_block = document.createElement('div');
              var editAuthor = document.createElement('a');
              var deleteAuthor = document.createElement('a');
              var name_author = document.createElement('p');
  ...
  $('#author').on('click', function (e) {
    $('#book').removeClass('active'); // <a class="btn btn-primary" href="/authors/create/" role="button">Добавить автора</a>
...
__webpack_require__(/*! /home/valeron/laravel/test/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/valeron/laravel/test/resources/sass/app.scss */"./resources/sass/app.scss");
